...
namespace RideOnCab.Migrations
{
    ...
    [Migration("20160207132211_WithRide")]
    partial class WithRide
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("RideOnCab.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("RideOnCab.Models.Cab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RideOnCab.Models.ApplicationUser")
                        .WithMany()
